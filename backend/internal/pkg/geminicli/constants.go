...
const (
	...
	// OAuth credentials must be supplied at runtime. They are intentionally not embedded
	// in source control so GitHub push protection and downstream secret scanners stay clean.
