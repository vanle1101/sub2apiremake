...
@media (min-width: 900px) {
  ...
  .imagine-button { color: #111; background: #eee; }
}
...
.account-card > div { color: var(--theme-text-tertiary); border-color: var(--theme-border); }
